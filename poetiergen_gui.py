...
class EditPopup:
    ...
    def popup_bonus(self, index):
        ...
        self.l = tk.Entry(
            self.win, width=100, font=("Arial", 16, "bold"), justify="center"
        )
        self.l.pack()
        center(self.win)
        self.l.focus()
...
test_list = [["Key", datetime.datetime(2018, 5, 9, 16, 20, 44, 57673), 37]]
...
tree = ttk.Treeview(
    frame.get_frame(), show="", height=list_length, columns=("Date", "Count")
)
